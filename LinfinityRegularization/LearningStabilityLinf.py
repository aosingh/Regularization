...
for i in range(0,100):
    ...
    weight_table, MSEcost = start_Linfinity_regression(x_train,y_train)
...
print "Stability of Linf over 100 iterations are = {:2e}(+/-{:.2e}), {:2e}(+/-{:2e}), {:2e}(+/-{:2e}))".format(mean1, variance1, mean2, variance2, mean3, variance3)
