...
from LassoRegularization import LassoRegressionTester
import pandas as pd
...
for i in range(0,100):
    ...
    weight_table, MSEcost = LassoRegressionTester.start_lasso_regression(x_train,y_train)
...
print "Stability of the L1 regularizer over 100 iterations are = {:2e}(+/-{:.2e}), {:2e}(+/-{:2e}), {:2e}(+/-{:2e}))".format(mean1, variance1, mean2, variance2, mean3, variance3)
