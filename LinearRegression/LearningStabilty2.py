...
from LinearRegressionTester import start_linear_regression
import pandas as pd
...
for i in range(0,100):
    ...
    weight_table, MSEcost = start_linear_regression(x_train,y_train)
...
print "Stability of Linear Regression over 100 iterations are = {:2e}(+/-{:.2e}), {:2e}(+/-{:2e}), {:2e}(+/-{:2e}))".format(mean1, variance1, mean2, variance2, mean3, variance3)
