...
weights_table, MSEcost = start_linear_regression(training_records=training_rec, output=out)
...
blue_patch = mpatches.Patch(color='blue', label="MSE Error for Linear Regression", )
