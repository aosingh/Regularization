...
weights_table, MSEcost = start_ridge_regression(training_records=training_rec, output=out)
itr = []
w1 = []
w2 = []
...
blue_patch = mpatches.Patch(color='blue', label="MSE Error for L2 Regularizer", )
...
y = w2
z = MSEcost
ax.plot(x, y, z, label='MSE Error curve for L2 Regularizer - In coefficient Space')
ax.legend()
